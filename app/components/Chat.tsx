    ...
    return (
        <div className='flex flex-col items-center p-4 relative h-screen'>
            <div className='mb-4'>
             ...
             <div className="w-full max-w-4x1 rounded-lg space-y-4 flex-grow overflow-y-auto no-scrollbar mb-40 p-5">
                <div className="space-y-2">
                    {messages.length === 0 ? (
                        <div className="p-4 flex justify-center items-center flex-col">
                            <div className="flex items-center">
                                <Sparkles className="w-10 h-10" />
                                <h1 className="font-bold text-3x1 my-4 text-primary">Talk.ai</h1>
                            </div>
                            <p className="text-2x1 mb-8">Comment puis-je vous aider ?</p>
            ...
            <form
                ...
                className="absolute bottom-4 left-4 right-4 md:left-auto md:right-auto
                md:w-full md:max-w-4xl p-4 rounded-3xl border border-base-300 flex items-center bg-base-300"
            >
